...
<body>
    <div class ="Center">
    	...
    	<a class="new-link" href="${pageContext.request.contextPath}/customer/bookOrders">SHOPING PAGE</a>
    	<a class="new-link" href="${pageContext.request.contextPath}/customer/addCash">CUSTOMER RECHARGE</a>
